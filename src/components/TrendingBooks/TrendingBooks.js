...
function TrendingBooks() {
  ...
  const books = [
    {
      id: 1,
      title: 'Dark Desire',
      author: 'By Summer Cooper',
      imageUrl: 'https://manybooks.net/sites/default/files/styles/220x330sc/public/2023-02/51SkGQ-K0AL.jpg?itok=GmIbqsU-',
      Genre:'Romance',
      detailUrl: '/book1',
    },
    {
  ...
  return (
    <div className="mt-8 mx-16">
      <h2 className="text-3xl font-bold border-b-4 border-lime-500 mb-8 pb-2">TRENDING BOOKS</h2>
