...
function CallOfCthulhu(props) {
  const { title, imageUrl, Genre, author } = props;
  ...
  return (
    ...
    <div className=" justify-between items-center">
      ...
      <p className='w-3/4 pb-4'>Three independent narratives linked together by the device of a narrator discovering notes left by a deceased relative. Piecing together the whole truth and disturbing significance of the information he possesses, the narrator's final line is ''The most merciful thing in the world, I think, is the inability of the human mind to correlate all its contents.''</p>
